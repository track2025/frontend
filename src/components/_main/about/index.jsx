        ...
        <Grid container>
          <Grid item md={6} xs={12} sx={{ display: "flex", flexDirection: "column", justifyContent: "center" }}>
            ...
            <Typography variant="body1" fontWeight={400} color="text.secondary" mt={2}>
              At Lap Snaps, we are passionate about motorsport and photography. Our mission is simple: to make it
              ...
              to find themselves in your gallery.
              <br /> <br />
              Every photographer receives a personal shop page with a profile and banner, along with a unique QR code
              that can be printed or shared at events. You set your own pricing and earn revenue automatically whenever
