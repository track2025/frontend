...
PhysicalCategoryForm.propTypes = {
...
export default function PhysicalCategoryForm({ data: currentCategory, isLoading: categoryLoading }) {
  ...
  const { mutate, isLoading } = useMutation(
    ...
    currentCategory ? api.updatePhysicalCategoryByAdmin : api.addPhysicalCategoryByAdmin,
    {
      ...(currentCategory && {
                ...
                <Stack spacing={3}>
                  ...
                  {categoryLoading ? (
                    ...
                    <LoadingButton
                      ...
                      sx={{ ml: 'auto', mt: 3 }}
                    >
                      {currentCategory ? 'Edit Physical Category' : 'Add New Physical Category'}
                    </LoadingButton>
                  )}
                </Stack>
              </div>
