...
import Blog from 'src/components/table/rows/blog';

const TABLE_HEAD = [
  { id: 'name', label: 'Blogs', alignRight: false, sort: true },
    ...
    <>
      <Dialog onClose={handleClose} open={open} maxWidth={'xs'}>
        <DeleteDialog
          ...
          type={'Record deleted'}
          deleteMessage={
            'Are you sure you want to delete this Blog? Please consider carefully before making irreversible changes.'
          }
        />
      </Dialog>
      <Table
