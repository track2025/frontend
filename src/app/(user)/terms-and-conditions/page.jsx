...
const TermsAndConditions = () => {
  return (
    <Container maxWidth="xl" sx={{ mt: 4, mb: 4 }}>
      ...
      <Typography variant="body1" paragraph>
        These Terms & Conditions (“Terms”) govern your use of lapsnaps.com (“Website”), operated by FB Ecom LTD and/or lapsnaps.com (“we”, “us”, or “our”), registered in the United Kingdom. By accessing or using the Website, you agree to these Terms. If you do not agree, you must not use the Website.
      </Typography>
      ...
      <Typography variant="body1" paragraph>
        LapSnaps is an online platform that connects photographers and videographers (“Creators”) with customers (“Buyers”) who wish to purchase a licence to use media from automotive events. We act as an intermediary — we are not the owner of the media sold (unless explicitly stated) and do not verify the accuracy or quality of uploaded media.
      </Typography>
      ...
      <Typography variant="body1" paragraph>
        You must create an account to upload, purchase, or download media. You must provide accurate information and keep it updated. You are responsible for maintaining the confidentiality of your account login details
      </Typography>
      ...
      <Typography variant="body1" paragraph>
        Media prices are set by the Creator. Digital sales are subject to a platform fee of 30% (70% to Creator, 30% to LapSnaps). Where applicable, Value Added Tax (VAT) or other sales taxes may be charged in accordance with the laws of the Buyer’s country, and will be added to the item price at checkout. Payments to Creators are made via the payment method linked to their account, subject to any applicable processing fees and tax withholding requirements.
      </Typography>
